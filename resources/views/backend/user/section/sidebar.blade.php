<ul class="generic-list-item off-canvas-menu-list off--canvas-menu-list pt-35px">
    ...
    <li class="">
        <a href="{{ route('user.my.courses') }}"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" height="18px"
                viewBox="0 0 24 24" width="18px">
                <path d="M0 0h24v24H0V0z" fill="none" />
                <path
    ...
    <li class="">
        <a href="{{ route('user.messages') }}"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" height="18px"
                viewBox="0 0 24 24" width="18px">
                <path d="M0 0h24v24H0V0z" fill="none" />
                <path
    ...
    <li class="">
        <a href="{{ route('user.purchase.history') }}"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg"
                height="18px" viewBox="0 0 24 24" width="18px">
                <path d="M0 0h24v24H0V0z" fill="none" />
                <path
