            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="footer-item">
                    ...
                    <ul class="social-icons social-icons-styled">
                        <li class="mr-1"><a href="https://www.facebook.com/ra.sarnav" target="_blank" class="facebook-bg"><i
                                    class="la la-facebook"></i></a></li>
                        <li class="mr-1"><a href="https://x.com/ruh4nX" target="_blank" class="twitter-bg"><i
                                    class="la la-twitter"></i></a></li>
                        <li class="mr-1"><a href="https://www.linkedin.com/in/ruhan-ahsan" target="_blank" class="linkedin-bg"><i
